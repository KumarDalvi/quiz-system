...
<div class="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md mt-10">
    ...
    <h2 class="text-2xl text-center text-gray-800 mb-6">Add Quiz</h2>
            ...
            <form action="/add-quiz" method="get" class="space-y-4">
                ...
                <div>
                    <input id="quiz" type="text" placeholder="Enter Quiz Name" name="quiz"
...
<form action="" method="get" class="space-y-4">
    <div>
        <textarea  type="text" placeholder="Enter Quiz Question" name="quiz"
    ...
    <div>
        <select   name="right answer"
            class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none">
            <option value="" disabled>Select Right Answer</option>
