...
<body>
    ...
    <div class="flex flex-col min-h-screen items-center bg-gray-100">
        ...
        <div class="w-full max-w-md">
            <div class="relative">
                <form action="search-quiz" method="get">
                    <input class="w-full px-4 py-3 text-gray-900 border border-gray-300
                rounded-2xl shadow focus:outline-none focus:ring-0" type="text" name="search" placeholder="Search quiz...">
        ...
        <div class="w-200">
            <h1 class="text-2xl text-green-900 text-center my-5 ">Top Quizzes</h1>
            <ul >
                <li class="p-2 font-bold">
                    <ul class="flex justify-between">
                ...
                <li class="even:bg-gray-200 p-2">
                    <ul class="flex justify-between ">
                        ...
                        <li class="w-50" >
                            <a href="/start-quiz/{{ $item->id }}/{{ $item->name }}" class="text-green-500 font-bold"> Attempt Quiz
                            </a>
                        </li>
                    </ul>
                </li>
