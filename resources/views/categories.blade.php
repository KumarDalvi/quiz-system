...
<body>
    ...
    <div class="bg-gray-100 flex flex-col items-center min-h-screen ">
        <div class="bg-white p-8 rounded-2xl shadow-lg w-full max-w-sm mt-10">
            <h2 class="text-2xl text-center text-gray-800 mb-6">Add Category</h2>
            
            <form action="/add-category" method="post" class="space-y-4">
                @csrf
                <div>
                    <input id="category_name" type="text" placeholder="Enter Category Name" name="category"
                    ...
                    <ul class="flex justify-between ">
                        ...
                        <li class="w-30 flex" >
                            <a href="categories/delete/{{ $category->id}}">
                                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="20px" fill="#1f1f1f"><path d="M312-144q-29.7 0-50.85-21.15Q240-186.3 240-216v-480h-48v-72h192v-48h192v48h192v72h-48v479.57Q720-186 698.85-165T648-144H312Zm336-552H312v480h336v-480ZM384-288h72v-336h-72v336Zm120 0h72v-336h-72v336ZM312-696v480-480Z"/></svg>
                            </a>
